...
public class Dados extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_TABLE_DISCIPLINAS = "CREATE TABLE DISCIPLINAS( _id INT PRIMARY KEY NOT NULL, DISCIPLINA TEXT NOT NULL, PESO INT NOT NULL, COR INT NOT NULL, TEMPO_TOTAL INT NOT NULL);";
